...
from app.services.change_flags import has_unread, mark_unread
...
def _run_check_unlocked(db, site_id: int):
    ...
    # Solange eine Änderung ungelesen ist, bleibt der bisherige Zustand
    # unverändert und es wird kein neuer Screenshot erzeugt.
    if has_unread(site_id):
        return None
